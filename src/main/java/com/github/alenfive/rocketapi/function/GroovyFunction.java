 ...
 */
@Slf4j
public class GroovyFunction extends AbsIFunction {

    public GroovyFunction(DataSourceManager dataSourceManager, ApiInfoContent apiInfoContent, ScriptParseService parseService, IApiPager apiPager, ISQLInterceptor sqlInterceptor) {
    ...
    private final ApiInfoContent apiInfoContent;

    private final ScriptParseService parseService;

    private final IApiPager apiPager;

    private final ISQLInterceptor sqlInterceptor;
